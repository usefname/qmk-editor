...
export const QKToCaption = new Map([
        ...
        ["KC_RCMD", "Right GUI"],
        ["KC_RWIN", "Right GUI"],
        ["KC_SYSTEM_POWER", "⚡ Down"],
        ["KC_PWR", "⚡ Down"],
        ["KC_SYSTEM_SLEEP", "Sleep"],
        ["KC_SLEP", "Sleep"],
        ["KC_SYSTEM_WAKE", "Wake up"],
        ["KC_WAKE", "Wake up"],
        ["KC_AUDIO_MUTE", "🔇"],
        ["KC_MUTE", "🔇"],
        ...
        ["KC_MS_ACCEL2", "🖱acc-2"],
        ["KC_ACL2", "🖱acc-2"],
        ["KC_MEH", "Left Control, Shift"],
        ["KC_HYPR", "Left Control, Shift, Alt"],
        ["KC_TILDE", "~"],
        ["KC_TILD", "~"],
        ["KC_EXCLAIM", "!"],
        ["KC_EXLM", "!"],
...
export const QKToDescription = new Map([
    ...
    ["KC_QUES", "?"],
    //Layer
        ["DF", "Set the base (default) layer"],
        ["MO", "Momentarily turn on layer when pressed (requires KC_TRNS on destination layer)"],
        ["OSL", "Momentarily activates layer until a key is pressed. See One Shot Keys for details."],
        ["TG", "Toggle layer on or off"],
        ["TO", "Turns on layer and turns off all other layers, except the default layer"],
        ["TT", "Normally acts like MO unless it's tapped multiple times, which toggles layer on"],
    //MultiLayer
