<script>
    ...
    import {captionToDescription, replaceFirstArgInCaption} from "@/lib/key-info.js";
                ...
                <div>
                    <table class="table is-bordered is-striped is-widescreen is-hoverable">
                        ...
                        {#each keyList as key}
                            <tr>
                                <td>
                                    <Keycap caption={key} exposeInner=true/>
                                </td>
                                <td>
                                    {captionToDescription(key)}
                                </td>
                            </tr>
                        {/each}
                    </table>
